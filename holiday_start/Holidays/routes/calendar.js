...
function getHolidayNL(date){
	...
	switch(true)
	{
		...
		case dd == 05 && mm == 04: return 'Bevrijdingsdag';
		case dd == 25 && mm == 11: return 'Eerste Kerstdag';
		case dd == 26 && mm == 11: return 'Tweede Kerstdag';
		case dd == easterSunday.getDate() && mm == easterSunday.getMonth(): return 'Eerste Paasdag';
		case dd == 02 && mm == 03: return 'Tweede Paasdag';
		case dd == 18 && mm == 04: return 'Hemelvaartsdag';
	}
